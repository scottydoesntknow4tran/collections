...
public:
  ...
  /* sorts the list elements using selection sort */
  virtual void selection_sort() = 0;

  /* sorts the list elements using insertion sort */
  virtual void insertion_sort() = 0;

  /* sorts the list elements using merge sort */
  virtual void merge_sort() = 0;

  /* sorts the list elements using quick sort */
